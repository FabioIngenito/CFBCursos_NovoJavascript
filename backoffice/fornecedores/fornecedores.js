...
const pagina = () => {
  ...
  const btn_fecharPopupListaContatos = document.querySelector(
    "#btn_fecharPopupListaContatos"
  );
  ...
  const btn_listarContatosForn = document.querySelector(
    "#btn_listarContatosForn"
  );
  const dadosGrid_novosContatosForn = document.querySelector(
    "#dadosGrid_novosContatosForn"
  );
  const dadosGrid_contatosFornAdd = document.querySelector(
    "#dadosGrid_ContatosFornAdd"
  );

  const telefonesContForn = document.querySelector("#telefonesContForn");
  const btn_fecharPopupTelefonesContForn = document.querySelector(
    "#btn_fecharPopupTelefonesContForn"
  );
  const dadosGrid_telefonesContForn = document.querySelector(
    "#dadosGrid_telefonesContForn"
  );
  ...
  const carregarTodosFornecedores = () => {
    ...
    //console.log(`Endpoint todosfornecedores: ${endpoint}`);
  ...
  btn_gravarPopup.addEventListener("click", (evt) => {
    ...
    if (modojanela == "n") {
      endpoint = `${serv}/novoform`;
    } else {
      endpoint = `${serv}/editarform`;
    }
